...
export default function SkillsAndStackHeader() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context((self) => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        tl.from(self.selector("#skills-and-stack-label"), {
          x: -250,
        })
          .from(self.selector("#skills-and-stack-title"), {
            x: -250,
          })
          .from(
            self.selector("#skills-and-stack-description"),
            {
              x: 250,
            },
            "<",
      ...
      mm.add("(max-width: 1023px)", () => {
        ...
        tl.from(self.selector("#skills-and-stack-label"), {
          ...
          .from(self.selector("#skills-and-stack-description"), {
            x: -250,
          });
      });
  ...
  return (
    ...
    >
      ...
      <p
        id="skills-and-stack-description"
